...
export const poems = [
  "چونکه بویی بُرد و شُکرِ آن نکرد     کفرِ نعمت آمد و بینی‌اش خَورد",
  "عاقبت دیدند هر گون مِلّتی     لاجَرَم گشتند اسیرِ زَلّتی‌‌",
  "عاقبت دیدن، نباشد دستْ‌باف     ور نه کی بودی ز دین‌ها اختلاف‌‌؟",
  "در یکی گفته که اُستا هم تویی     ز آنکه اُستا را شناسا هم تویی‌‌",
  "هر یکی قولی است ضِدِّ همدگر     چون یکی باشد، یکی زهر و شکر؟",
  "مکرِ شیطان هم در او پیچید، شُکر     دیو هم خود را سِیَه‌رُو دید، شُکر",
  "سعیِ شُکرِ نعمتش، قدرت بُوَد      جبرِ تو، انکارِ آن نعمت بُوَد",
  "شُکرِ قدرت، قدرتت افزون کند      جبر، نعمت از کَفَت بیرون کند",
  "گر تُرُشْ رُو بودن آمد شُکر و بس     پس چو سِرکه، شُکر گویی نیست کس‌‌",
  "سِرکه را گر راه باید در جگر     گو: بشو سرکنگبین، او از شِکر",
  "چون تو شیرین از شکر باشی، بود     کآن شکر گاهی ز تو غایب شود؟",
  "چون شِکَر گردی ز بسیاری وفا     پس شِکَر کی از شکر باشد جدا؟ ",
  "لقمهٔ حکمی که تلخی می‌نهد    گُلْشکر آن را گوارش می‌دهد",
  "گلشکر آن را که نَبْوَد مُسْتَنَد    لقمه را ز انکارِ او قِی می‌کند",
  "هر که خوابی دید از روزِ اَلَسْت    مست باشد در رَهِ طاعات، مست",
  "شکرِ نعمت، خوشتر از نعمت بُوَد    شُکرْباره کَی سویِ نعمت رود؟",
  "شُکر، جانِ نعمت و، نعمت چو پوست    زآنکه شُکر آرد تو را تا کویِ دوست",
  "نعمت آرد غفلت و، شُکر انتباه    صیدِ نعمت کن به دامِ شُکرِ شاه",
  "نعمت شکرت کند پُرچشم و میر    تا کنی صد نعمت ایثارِ فقیر",
  "شهرِ ما فردا پُر از شِکَّر شود    شِکَّر ارزان‌ست، ارزان‌تر شود",
  "در شِکَر غلطید ای حلواییان    همچو طوطی، کوریِ صفراییان",
  ...
  "شُکرِ او شکرِ خدا باشد یقین    چون به احسان، کرد توفیقش قرین",
  "تَرکِ شُکرش، تَرکِ شُکرِ حق بود    حقِّ او لا شَک به حق مُلحَق بود",
  "شُکر می‌کن مر خدا را در نِعَم    نیز می‌کن شکر و ذکرِ خواجه هم",
];
